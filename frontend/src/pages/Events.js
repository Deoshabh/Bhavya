                ...
                <Grid container spacing={2} alignItems="center">
                                    ...
                                    <Paper>
                                        <ClickAwayListener onClickAway={handleCategoryMenuClose}>
                                            <MenuList id="category-menu" autoFocusItem>
                                                <MenuItem onClick={(e) => handleCategoryMenuClose(e, 'all')}>
                                                    All Categories
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleCategoryMenuClose(e, 'conference')}>
                                                    Conference
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleCategoryMenuClose(e, 'exhibition')}>
                                                    Exhibition
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleCategoryMenuClose(e, 'workshop')}>
                                                    Workshop
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleCategoryMenuClose(e, 'trade_show')}>
                                                    Trade Show
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleCategoryMenuClose(e, 'other')}>
                                                    Other
                                                </MenuItem>
                                            </MenuList>
                                        </ClickAwayListener>
                    ...
                    <Grid item xs={12} md={4}>
                        <Button
                            ...
                            aria-haspopup="true"
                        >
                            {filters.sort === 'startDate' ? 'Sort by Date' : 
                             filters.sort === 'price' ? 'Price: Low to High' : 
                             'Price: High to Low'}
                        </Button>
                        <Popper
                            open={sortMenuOpen}
                                    ...
                                    <Paper>
                                        <ClickAwayListener onClickAway={handleSortMenuClose}>
                                            <MenuList id="sort-menu" autoFocusItem>
                                                <MenuItem onClick={(e) => handleSortMenuClose(e, 'startDate')}>
                                                    Sort by Date
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleSortMenuClose(e, 'price')}>
                                                    Price: Low to High
                                                </MenuItem>
                                                <MenuItem onClick={(e) => handleSortMenuClose(e, 'price-desc')}>
                                                    Price: High to Low
                                                </MenuItem>
                                            </MenuList>
                                        </ClickAwayListener>
