        ...
        <div className="grid grid-cols-2 xs:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div className="col-span-2 xs:col-span-2 md:col-span-1">
            ...
            <p className="text-gray-600 text-xs sm:text-sm">
              Your one-stop platform for discovering and booking the best
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-gray-600 hover:text-black text-xs sm:text-sm block py-1"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <button
                type="button"
                onClick={() => {}}
                className="text-gray-600 hover:text-black p-1.5 bg-transparent border-0 cursor-pointer"
                aria-label="Facebook"
              >
